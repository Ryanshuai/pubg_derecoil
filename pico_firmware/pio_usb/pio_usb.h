...
// Low-level control transfer (exposed for vendor commands)
int control_out_protocol(usb_device_t *device, uint8_t *setup_data,
                         uint16_t setup_length, uint8_t *out_data,
                         uint16_t out_length);
